...
function readzl(si,id,wenzhang,sign,body) {
    return {
       
    
        url: 'https://script.baertt.com/count2/callback?si=' + si + '&referer=https%253A%252F%252Ffocus.youth.cn%252Farticle%252Fs%253Fsignature%253D'+wenzhang+'%2526uid%253D'+`&${myuid}`+'%2526phone_code%253Da2823679662e562c3bb1fade2b2f3d5b%2526scid%253D'+id+'%2526time%253D'+timea+'%2526app_version%253D2.0.2%2526sign%253D'+sign+'&_='+new Date().getTime()+'&jsonpcallback=jsonp6',
...
function readshare(artsid,wenzhang) {
    ...
    var suiji=Math.ceil(Math.random() * 6);
